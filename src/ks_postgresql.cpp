...
void PostgreSQLClient::convert_unsupported_database_schema(Database &database) {
	...
	for (Table &table : database.tables) {
		// normally we're syncing from an entire database to an entire database, and default_schema will be left on "public".
		// if it's set to anything else, we're syncing into a single specific schema.
